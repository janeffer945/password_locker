...
class TestUser(unittest.TestCase):
      ...
      def setUp(self):
          ...
          """
          self.new_user = User("janefer", "janeffer945")# create user object

      def test__init(self):
          """
          test__init test case to test if the object is initialized properly
          """
          self.assertEqual(self.new__user.user_name, "janeffer")
          self.assertEqual(self.new_user.user_name, "janeffer")
